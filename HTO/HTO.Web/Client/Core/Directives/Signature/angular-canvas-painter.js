...
(function (window) {
    ...
    (function (module) {
        try {
            module = angular.module('hto');
        } catch (e) {
            module = angular.module('hto', []);
        }
        module.run(['$templateCache', function ($templateCache) {
            $templateCache.put('/Client/Core/Directives/Signature/canvas.html',
    ...
    (function (module) {
        ...
        module.run(['$templateCache', function ($templateCache) {
            $templateCache.put('/Client/Core/Directives/Signature/color-selector.html',
    ...
    angular.module('hto')
      .directive('pwColorSelector', function () {
          return {
              ...
              templateUrl: '/Client/Core/Directives/Signature/color-selector.html',
              link: function (scope) {
